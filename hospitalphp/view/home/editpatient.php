...
<form method="POST" action="">
    <div class="create">
        ...
        <input type="text" name="name" placeholder="Knuckles" value="<?php echo $user['patient_name']; ?>" required>
        <br>
        ...
        <select type="text" placeholder="species" name="species" required>
            <?php
                ...
                {
                    if($specie['species_id'] == $user['species_id']){
        ...
        <textarea style="max-width: 500px; max-height: 250px; min-height: 100px; min-width: 340px;" name="status" value="<?php echo $user['patient_status']; ?>" required><?php echo $user['patient_status']; ?></textarea>
        <br>
